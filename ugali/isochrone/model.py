...
class IsochroneModel(Model):
    ...
    defaults = (
        ...
        ('imf_type','Salpeter1955','Initial mass function'),
    ...
    def __init__(self, **kwargs):
        ...
        self.imf.alphaIMF = self.params['alphaIMF']
    ...
    def stellar_luminosity(self, steps=10000):
        ...
        for the old and metalpoor stellar populations of interest.
...
class Isochrone(IsochroneModel):
    ...
    def feh(self):
        ...
        Thus, to properly calculate [Fe/H] requires definition of the
...
#        if name in ['alphaIMF']: self.imf.alphaIMF = self.alphaIMF
